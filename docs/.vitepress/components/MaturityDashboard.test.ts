...
describe('MaturityDashboard', () => {
  it('renders live example readiness after the depth queue is complete', () => {
    ...
    expect(wrapper.text()).toContain('Source repro')
    ...
    expect(wrapper.text()).toContain('Element Plus Installation Compatibility')
    ...
    expect(wrapper.text()).toContain('Source panel context')
    ...
    expect(wrapper.findAll('.maturity-dashboard__source-panel-card')).toHaveLength(6)
    expect(wrapper.text()).toContain('adoption readiness')
    expect(wrapper.text()).toContain('Package preset install commands')
    expect(wrapper.text()).toContain('unplugin-vue-components resolver')
    expect(wrapper.text()).toContain('Type declarations and package exports')
    expect(wrapper.text()).toContain('Theme CSS export contract')
    expect(wrapper.findAll('.maturity-dashboard__adoption-card')).toHaveLength(5)
    expect(wrapper.findAll('.maturity-dashboard__adoption-gate')).toHaveLength(8)
    expect(wrapper.text()).toContain('support matrix')
    expect(wrapper.text()).toContain('Modern browser baseline')
    expect(wrapper.text()).toContain('SSR hydration boundary')
    expect(wrapper.text()).toContain('CSS variable theme runtime')
    expect(wrapper.findAll('.maturity-dashboard__support-card')).toHaveLength(5)
    expect(wrapper.findAll('.maturity-dashboard__support-item')).toHaveLength(9)
    ...
    expect(wrapper.text()).toContain('当前组件页的 API Live、Source、A11y、Theme 和源码复现证据都已达标。')
  })
})
