...
const componentStubs = {
  ...
  YCascaderPanel: { template: '<section />' },
  ...
  YVirtualTable: { template: '<div role="table" />' },
...
describe('PlaygroundWorkbench', () => {
  ...
  it.each([
    ...
    ['virtualTable', 'Virtual Table', '<YVirtualTable', 'virtualTableRows'],
    ...
    ['virtualTree', 'Virtual Tree', '<YVirtualTree', 'virtualTreeNodes'],
    ['treeSelect', 'Tree Select', '<YTreeSelect', 'treeSelectValue'],
    ['cascaderPanel', 'Cascader Panel', '<YCascaderPanel', 'cascaderOptions'],
