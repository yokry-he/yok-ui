...
::: tip TIP
`YFloatButton` 文档已按 Select 页面同一套结构组织：每个场景独立成段，示例块保留 TS/JS 切换、复制代码和展开源码，API 与可访问性约定集中在页尾。
:::

## Page shortcut {#float-button-page-shortcut}
...
## Action group {#float-button-action-group}
...
## Float Button API {#float-button-api}
