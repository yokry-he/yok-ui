...
::: tip TIP
`YMessageBox` 文档已按 Select 页面同一套结构组织：每个场景独立成段，示例块保留 TS/JS 切换、复制代码和展开源码，API 与可访问性约定集中在页尾。
:::
...
## Service API {#message-box-service-api}
...
## Usage notes {#message-box-usage-notes}
...
## Message Box API {#message-box-api}
