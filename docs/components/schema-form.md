...
::: tip TIP
`YSchemaForm` 文档已按 Select 页面同一套结构组织：每个场景独立成段，示例块保留 TS/JS 切换、复制代码和展开源码，API 与可访问性约定集中在页尾。
:::

## Basic Schema {#schema-form-basic-schema}
...
## Compact Density {#schema-form-compact-density}
...
## Custom Field Slot {#schema-form-custom-field-slot}
...
## Schema Form API {#schema-form-api}
