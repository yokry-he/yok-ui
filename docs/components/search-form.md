...
::: tip TIP
`YSearchForm` 文档已按 Select 页面同一套结构组织：每个场景独立成段，示例块保留 TS/JS 切换、复制代码和展开源码，API 与可访问性约定集中在页尾。
:::

## Advanced Search {#search-form-advanced-search}
...
## Compact In CRUD Layout {#search-form-compact-in-crud-layout}
...
## Built-in Date And Async Filters {#search-form-built-in-date-and-async-filters}
...
## Custom Field {#search-form-custom-field}
...
## Search Form API {#search-form-api}
