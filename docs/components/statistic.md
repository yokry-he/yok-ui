...
::: tip TIP
`YStatistic` 文档已按 Select 页面同一套结构组织：每个场景独立成段，示例块保留 TS/JS 切换、复制代码和展开源码，API 与可访问性约定集中在页尾。
:::

## Basic statistics {#statistic-basic-statistics}
...
## Unit And Precision {#statistic-unit-and-precision}
...
## Usage notes {#statistic-usage-notes}
...
## Formatter And Loading {#statistic-formatter-and-loading}
...
## Custom Value {#statistic-custom-value}
