...
::: tip TIP
`YTransfer` 文档已按 Select 页面同一套结构组织：每个场景独立成段，示例块保留 TS/JS 切换、复制代码和展开源码，API 与可访问性约定集中在页尾。
:::

## Basic transfer {#transfer-basic-transfer}
...
## Filterable lists {#transfer-filterable-lists}
...
## Member assignment {#transfer-member-assignment}
...
## Usage notes {#transfer-usage-notes}
