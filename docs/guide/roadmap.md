...
| Core | Ready | 41 个基础组件，覆盖表单校验、文本/数字输入、滑块、评分、颜色、日期/时间/范围选择、层级/穿梭选择、反馈、页面结果、弹层、数据展示、列表、详情描述、统计数值、时间线、表格排序/选择、异步/虚拟化树、虚拟滚动和命令式反馈 API |
...
| Package | Candidates |
| --- | --- |
| Core | Date presets with time、Async cascader loading、Tree refresh / reloadNode API |
