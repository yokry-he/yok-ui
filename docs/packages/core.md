...
const corePreviewCode = [
  ...
  '  <YStatistic title="Core components" :value="49" suffix="ready" tone="success" />',
...
import '@yok-ui/themes/yok-light.css'
import '@yok-ui/core/style.css'
import { YButton, YDateTimePicker, YDescriptions, YInput, YInputOtp, YInputTag, YList, YStatistic, YThemeProvider, YTimeSelect, YVirtualizedSelect } from '@yok-ui/core'
```
